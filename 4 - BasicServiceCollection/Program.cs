/*
ServiceCollection - a bucket of metadata, list of services where you declare which implementation of each interface must be used
ServiceProvider - a bucket of objects, list of instances that can be used and injected
*/
